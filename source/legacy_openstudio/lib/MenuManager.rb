...
# "Add Zone" better?
      ...
      @new_daylighting_cmd = UI::Command.new("New Daylighting Reference Point Tool") { Sketchup.active_model.select_tool(@new_daylighting_tool)  }
      ...
      @new_daylighting_cmd.tooltip = "New EnergyPlus Daylighting Reference Point"
      @new_daylighting_cmd.status_bar_text = "Create a new EnergyPlus daylighting reference point"
