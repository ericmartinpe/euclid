  ...
  class PluginManager
    ...
    def default_preferences
      ...
      if (platform == Platform_Windows)
        ...
        hash['EnergyPlus Path'] = "C:/EnergyPlusV9-2-0/EnergyPlus.exe"  # Default installation path
      elsif (platform == Platform_Mac)
        hash['Text Editor Path'] = "/Applications/TextEdit.app"
        hash['EnergyPlus Path'] = "/Applications/EnergyPlus-9-2-0/energyplus"  # Default installation path
    ...
    def energyplus_version
      return(Gem::Requirement.new("~>9.2.0"))  # Version requirement using twiddle wakka notation
    end
