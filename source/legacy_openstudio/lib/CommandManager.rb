...
module LegacyOpenStudio
  ...
  class CommandManager
    ...
    def open_input_file
      ...
      if (path = UI.open_panel("Open EnergyPlus Input File", Plugin.model_manager.input_file_dir, "EnergyPlus Files|*.epJSON;*.idf|EnergyPlus epJSON|*.epJSON;|EnergyPlus IDF|*.idf|All Files|*.*||"))
    ...
    def merge_input_file
      if (path = UI.open_panel("Merge EnergyPlus Input File", Plugin.model_manager.input_file_dir, "EnergyPlus Files|*.epJSON;*.json;*.idf|EnergyPlus epJSON|*.epJSON;*.json|EnergyPlus IDF|*.idf|All Files|*.*||"))
    ...
    def prompt_for_save
      if (Plugin.model_manager.input_file && Plugin.model_manager.input_file.modified?)
