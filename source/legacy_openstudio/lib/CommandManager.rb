...
module LegacyOpenStudio
  ...
  class CommandManager
    ...
    def open_input_file
      ...
      if (path = UI.open_panel("Open EnergyPlus Input File", Plugin.model_manager.input_file_dir, "EnergyPlus epJSON|*.epJSON;*.json|EnergyPlus IDF|*.idf|All Files|*.*||"))
    ...
    def merge_input_file
      if (path = UI.open_panel("Merge EnergyPlus Input File", Plugin.model_manager.input_file_dir, "EnergyPlus epJSON|*.epJSON;*.json|EnergyPlus IDF|*.idf|All Files|*.*||"))
