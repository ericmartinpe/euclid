  ...
  class DaylightingControlsInfoInterface < DialogInterface
    ...
    def populate_hash
      ...
      if (not @drawing_interface.nil?)
        ...
        @hash['SENSOR_NAME'] = @input_object.fields[1].to_s
        ...
        #   if daylighting_controls.zone == @input_object.fields[2]
        #     reference_points += 1
        #   end
        # end
        # @hash['REFERENCE_POINTS'] = reference_points
    ...
    def report
      ...
      @input_object.fields[1] = @hash['SENSOR_NAME'].strip
